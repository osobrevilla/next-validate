...
/* WEBPACK VAR INJECTION */(function(global) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    ...
    factory(module, exports, require('./validates'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.validates);
    global.nextvalidate = mod.exports;
  }
})(this, function (module, exports, _validates) {
  'use strict';
  ...
  var _getDataSelectors = function _getDataSelectors() {
    return Object.keys(_validates2.default.getRules()).map(function (frag) {
  ...
  var NextValidate = function () {
    ...
    _createClass(NextValidate, [{
      ...
      value: function _parse() {
        ...
        _getFormFields(this.form).map(function (field) {
          ...
          for (var _name in directives.attrs) {
            if (_validates2.default[_name]) {
              if (directives.attrs[_name]) {
                validatesFns.push(_validates2.default[_name.toLowerCase()](_getArgsFromDirective(directives.attrs[_name])));
              } else {
                validatesFns.push(_validates2.default[_name.toLowerCase()]);
              }
            }
          }
      ...
      value: function _unbindEvents() {
        this._validates_.forEach(function (validate) {
      ...
      value: function isValid() {
        ...
        [].forEach.call(this._validates_, function (validate) {
